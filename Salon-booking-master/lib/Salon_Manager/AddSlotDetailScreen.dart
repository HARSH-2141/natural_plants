...
class AddSlotDetailScreen extends StatefulWidget {
  const AddSlotDetailScreen({super.key});

  @override
  State<AddSlotDetailScreen> createState() => _AddSlotDetailScreenState();
}

class _AddSlotDetailScreenState extends State<AddSlotDetailScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (form!.validate()) {
      ...
      final login_url = Uri.parse("${ApiConst.base_url}salon/addslot.php");
