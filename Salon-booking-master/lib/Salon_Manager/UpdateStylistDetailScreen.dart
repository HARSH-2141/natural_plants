...
class UpdateStylistDetailScreen extends StatefulWidget {
  var stylistDetail;
  UpdateStylistDetailScreen({required this.stylistDetail});

  @override
  State<UpdateStylistDetailScreen> createState() => _AddStylistdetailscreenState();
}

class _AddStylistdetailscreenState extends State<UpdateStylistDetailScreen> {
  ...
  getData(){
    var userData = widget.stylistDetail; // Extract first user
    setState(() {
      isLoading = false;
      stylishId = userData["stylist_id"] ?? "";
  ...
  Future<void> _submit() async {
    ...
    if (form!.validate()) {
      ...
      final login_url = Uri.parse("${ApiConst.base_url}salon/update_stylist.php");
